...
function App() {
	...
	return (
		...
		>
			<Typography style={{ color: "#10AFAE", textAlign: "center", marginTop: 50 }} variant="body1">
				BTC Playground
			</Typography>
			<Paper
				elevation={3}
			...
			>
				...
				>
					<Tabs value={value} onChange={handleChange} aria-label="basic tabs example" TabIndicatorProps={{ style: { background: "#10AFAE" } }}>
						<Tab label="Mnemonic" {...a11yProps(0)} style={{ color: "#fff", fontSize: 12 }} />
						<Tab label="Address" {...a11yProps(1)} style={{ color: "#fff", fontSize: 12 }} />
						<Tab label="Multi-sig Address" {...a11yProps(2)} style={{ color: "#fff", fontSize: 12 }} />
					</Tabs>
				</Box>
